...
const ViewDefinitionForm = ({
	...
	const [expandedItemIds, setExpandedItemIds] = useLocalStorage<string[]>({
		...
		defaultValue: ["viewDefinition", "_constant"],
	});
			...
			case "name":
				return (
					<div className="flex w-full items-center justify-between">
						{labelView(item)}
						<div className="w-[50%]">
							<InputView placeholder="ViewDefinition name" />
						</div>
					</div>
				);
			case "resource":
